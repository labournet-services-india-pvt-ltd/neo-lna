  ...
  //end Mihir
    switch ($filearea) {
        ...
        case 'content':
          ...
          //first the referer skills labournet mihir
          //check if it is having mp4 and if it is directly getting accessed then return false
          // global $SESSION;
          ...
          //   $findme   = 'view.php';
          //   $pos = strpos($urltogo, $findme); // we are searching
          //   if ($pos !== false) {
          //   } else {
          //     return false;
          //   }
          // } else {
          //   if ($SESSION->hvpgood == 1) {
          //   } else {
          //     return false;
          //   }
          // }
