        ...
        if (empty($sortedcourses)) {
           ...
           // print_object($sortedcourses);
            ...
            foreach ($sortedcourses as $key => $value) {
              if($value->shortname == 'PRE_ASSESSMENT' OR $value->shortname == 'Pre_Test'){

              }else{
                $sortedcoursesnew[] = $value;
              }
            }
          /*  $this->content->text .= $renderer->lw_courses($sortedcourses);
            $this->content->text .= $renderer->hidden_courses($totalcourses - count($sortedcourses));
*/          //dont not show show pre assessment ourses
            $this->content->text .= $renderer->lw_courses($sortedcoursesnew);
            //$this->content->text .= $renderer->hidden_courses($totalcourses - count($sortedcoursesnew));
        }
