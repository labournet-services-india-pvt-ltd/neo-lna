...
//new code is added by prashant on dec-17-2019
$string['uploadhrd'] = 'Upload courses';
$string['uploadfile'] = 'Upload csv file';
$string['insert'] = 'Record Inserted Successfully!';
$string['permision'] = 'Access is denied';
