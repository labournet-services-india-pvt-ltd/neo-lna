...
$ADMIN->add('accounts', new admin_externalpage('tooluploaduseressci',
        get_string('uploadhrd', 'tool_uploaduser'), "$CFG->wwwroot/$CFG->admin/tool/uploaduser/upload_essci_file.php",'moodle/site:uploadusers'));
