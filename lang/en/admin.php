...
$string['configallowemojipickerincompatible'] = 'Your current database configuration does not properly support emojis. In order to enable the emoji picker you will need to upgrade your database for full unicode support</a>.';
...
$string['configallowoverride2'] = 'Select which role(s) can be overridden by each role in the left column.<br />Note that these settings only apply to users who have either the capability site/role:override or the capability site/role:safeoverride allowed.';
$string['configallowswitch'] = 'Select which roles a user may switch to, based on which roles they already have. In addition to an entry in this table, a user must also have the site/role:switchroles capability to be able to switch.<br />Note that it is only possible to switch to roles that have the site/course:view capability, and that do not have the site/site:doanything capability, so some columns in this table are disabled.';
$string['configallowthemechangeonurl'] = 'If enabled, the theme can be changed by adding either:<br />?theme=themename to any Site URL (eg: mysitesite.com/?theme=afterburner ) or <br />&theme=themename to any internal Site URL .';
...
$string['configallowuserswitchrolestheycantassign'] = 'By default, Site/role:assign is required for users to switch roles. Enabling this setting removes this requirement, and results in the roles available in the "Switch role to" dropdown menu being determined by settings in the "Allow role assignments" table only.
...
<pre>
Site community|https://Site.org
-Site free support|https://Site.org/support
-Site Docs|https://docs.Site.org|Site Docs
-Site Site Docs|https://Site.Site.org/de|Documentation in German|de
-###
-Site development|https://Site.org/development
...
$string['configdocroot'] = 'Defines the path to the Site Docs for providing context-specific documentation via \'Site Docs for this page\' links in the footer of each page. If the field is left blank, links will not be displayed.';
$string['configdoctonewwindow'] = 'If you enable this, then links to Site Docs will be shown in a new window.';
...
$string['configenablecourserequests'] = 'If enabled, users with the capability to request new courses (site/course:request) will have the option to request a course. This capability is not allowed for any of the default roles. It may be applied in the system or category context.';
$string['configenablemobilewebservice'] = 'Enable mobile service for the official Site app or other app requesting it. For more information, read the {$a}';
...
$string['configenablestats'] = 'If you choose \'yes\' here, Site\'s cronjob will process the logs and gather some statistics.  Depending on the amount of traffic on your site, this can take awhile. If you enable this, you will be able to see some interesting graphs and statistics about each of your courses, or on a sitewide basis.';
$string['configenabletrusttext'] = 'By default Site will always thoroughly clean text that comes from users to remove any possible bad scripts, media etc that could be a security risk.  The Trusted Content system is a way of giving particular users that you trust the ability to include these advanced features in their content without interference.  To enable this system, you need to first enable this setting, and then grant the Trusted Content permission to a specific Site role.  Texts created or uploaded by such users will be marked as trusted and will not be cleaned before display.';
$string['configenablewebservices'] = 'Web services enable other systems to log in to this Site and perform operations.  For extra security this feature should be disabled unless you are really using it.';
...
$string['configgeoipfile'] = 'Location of GeoLite2 City binary data file. This file is not part of Site distribution and must be obtained separately from <a href="https://www.maxmind.com/">MaxMind</a>. You can either buy a commercial version or use the free version.';
...
$string['configintro'] = 'On this page you can specify a number of configuration variables that help make Site work properly on your server.  Don\'t worry too much about it - the defaults will usually work fine and you can always come back to this page later and change these settings.';
...
$string['configlangstringcache'] = 'Caches all the language strings into compiled files in the data directory.  If you are translating Site or changing strings in the Site source code then you may want to switch this off.  Otherwise leave it on to see performance benefits.';
...
$string['configrecaptchaprivatekey'] = 'String of characters (secret key) used to communicate between your Site server and the recaptcha server. ReCAPTCHA keys can be obtained from <a target="_blank" href="https://www.google.com/recaptcha">Google reCAPTCHA</a>.';
...
$string['configsecureforms'] = 'Site can use an additional level of security when accepting data from web forms. If this is enabled, then the browser\'s HTTP_REFERER variable is checked against the current form address.  In a very few cases this can cause problems if the user is using a firewall (eg Zonealarm) configured to strip HTTP_REFERER from their web traffic.  Symptoms are getting \'stuck\' on a form. If your users are having problems with the login page (for example) you might want to disable this setting, although it might leave your site more open to brute-force password attacks.  If in doubt, leave this set to \'Yes\'.';
$string['configsessioncookie'] = 'This setting customises the name of the cookie used for Site sessions.  This is optional, and only useful to avoid cookies being confused when there is more than one copy of Site running within the same web site.';
$string['configsessioncookiedomain'] = 'This allows you to change the domain that the Site cookies are available from. This is useful for Site customisations (e.g. authentication or enrolment plugins) that need to share Site session information with a web application on another subdomain. <strong>WARNING: it is strongly recommended to leave this setting at the default (empty) - an incorrect value will prevent all logins to the site.</strong>';
$string['configsessioncookiepath'] = 'If you need to change where browsers send the Site cookies, you can change this setting to specify a subdirectory of your web site.  Otherwise the default \'/\' should be fine.';
...
$string['configslasharguments'] = '\'Slash arguments\' (using <em>PATH_INFO</em>) is required for SCORM packages and multiple-file resources to display correctly. If your web server doesn\'t support \'slash arguments\' and you are unable to configure it, this setting can be disabled, though it will result in things not working.<br />Note: The use of \'slash arguments\' will be required in future versions of Site.';
$string['configsmartpix'] = 'With this on, icons are served through a PHP script that searches the current theme, then all parent themes, then the Site /pix folder. This reduces the need to duplicate image files within themes, but has a slight performance cost.';
$string['configsmtpauthtype'] = 'This sets the authentication type to use on smtp server.';
$string['configsmtphosts'] = 'Give the full name of one or more local SMTP servers that Site should use to send mail (eg \'mail.a.com\' or \'mail.a.com;mail.b.com\'). To specify a non-default port (i.e other than port 25), you can use the [server]:[port] syntax (eg \'mail.a.com:587\'). For secure connections, port 465 is usually used with SSL, port 587 is usually used with TLS, specify security protocol below if required. If you leave this field blank, Site will use the PHP default method of sending mail.';
...
$string['configstatsruntimestart'] = 'What time should the cronjob that does the statistics processing start? Specifying different times is recommended if there are multiple Site sites on one server.';
...
$string['ctyperequired'] = 'The ctype PHP extension is now required by Site, in order to improve site performance and to offer multilingual compatibility.';
...
$string['curlrequired'] = 'The cURL PHP extension is now required by Site, in order to communicate with Site repositories.';
...
$string['debugdeveloper'] = 'DEVELOPER: extra Site debug messages for developers';
...
$string['docroot'] = 'Site Docs document root';
$string['doctonewwindow'] = 'Open in new window';
$string['doesnotfit'] = 'Email display settings';
$string['doesnotfitdetail'] = 'Display settings for email leaving Site.';
...
$string['enablegravatar_help'] = 'When enabled Site will attempt to fetch a user profile picture from Gravatar if the user has not uploaded an image.';
...
$string['environmenterrortodo'] = 'You must solve all the environmental problems (errors) found above before proceeding to install this Site version!';
$string['environmenterrorupgrade'] = 'Warning: you should solve all the environmental problems (errors) found above before proceeding to upgrade this Site version!  Upgrading without fixing these requirements could cause problems such as data loss.  Are you sure you want to continue with the upgrade?';
...
$string['eventshandlersinuse'] = 'The following plugins in your system are using Events 1 API deprecated handlers: \'{$a}\'. Please, update them to use Events 2 API. Event_2#Event_dispatching_and_observers.';
...
$string['fatalsessionautostart'] = '<p>Serious configuration error detected, please notify server administrator.</p><p> To operate properly, Site requires that administrator changes PHP settings.</p><p><code>session.auto_start</code> must be set to <code>off</code>.</p><p>This setting is controlled by editing <code>php.ini</code>, Apache/IIS <br />configuration or <code>.htaccess</code> file on the server.</p>';
...
$string['gdrequired'] = 'The GD extension is now required by Site for image conversion.';
...
$string['gravatardefaulturl_help'] = 'Gravatar needs a default image to display if it is unable to find a picture for a given user. Provide a full URL for an image. If you leave this setting empty, Site will attempt to use the most appropriate default image for the page you are viewing. Note also that Gravatar has a number of codes which can be used to <a href="https://en.gravatar.com/site/implement/images/#default-image">generate default images</a>.';
...
$string['iplookupinfo'] = 'By default Site uses the free online NetGeo (The Internet Geographic Database) server to lookup location of IP addresses, unfortunately this database is not maintained anymore and may return <em>wildly incorrect</em> data.
...
$string['langpackwillbeupdated'] = 'NOTE: Site will try to download updates for your language packs during the upgrade.';
...
$string['maturitycorewarning'] = 'The version of Site that you are about to install or upgrade to contains
...
from a STABLE branch of the Site code. See Site Docs for more details.';
...
$string['mnetrestore_extusers'] = '<strong>Note:</strong> This backup file contains remote Site Network user accounts which will be restored as part of the process.';
$string['mnetrestore_extusers_admin'] = '<strong>Note:</strong> This backup file seems to come from a different Site installation and contains remote Site Network user accounts. The restore process will try to match the Site Network hosts for all created users. Those not matching will be automatically switched to internal authentication (instead of mnet one). The restore log will inform you about that.';
$string['mnetrestore_extusers_mismatch'] = '<strong>Note:</strong> This backup file apparently originates from a different Site installation and contains remote Site Network user accounts that may fail to restore. This operation is unsupported. If you are certain that it was created on this Site installation, or you can ensure that all the needed Site Network Hosts are configured, you may want to still try the restore.';
$string['mnetrestore_extusers_noadmin'] = '<strong>Note:</strong> This backup file seems to come from a different Site installation and contains remote Site Network user accounts. You are not allowed to execute this type of restore. Contact the administrator of the site or, alternatively, restore this course without any user information (modules, files...)';
$string['mnetrestore_extusers_switchuserauth'] = 'Remote Site Network user {$a->username} (coming from {$a->mnethosturl}) switched to local {$a->auth} authenticated user.';
$string['mobilenotconfiguredwarning'] = 'The Site app is not enabled.';
...
$string['mymoodleredirect'] = 'Force users to use My Site';
...
$string['nohttpsformobilewarning'] = 'It is recommended to enable HTTPS with a valid certificate. The Site app will always try to use a secured connection first.';
...
$string['maxtimelimit_desc'] = 'To restrict the maximum PHP execution time that Site will allow without any output being displayed, enter a value in seconds here. 0 means that Site default restrictions are used. If you have a front-end server with its own time limit, set this value lower to receive PHP errors in logs. Does not apply to CLI scripts.';
$string['moodleapp'] = 'Site app';
$string['moodleapp_help'] = '<p>If you have an account on a Site site, you can access all your courses on your mobile devices with our free mobile app for site.</p>
<a href="https://site.com/mobile-app">Get the Site app</a>';
$string['moodlebrandedapp'] = 'Branded Site app';
$string['moodlebrandedapp_help'] = '<p>The Branded Site app has all the functionality of our free mobile app for Site combined with your own custom branding.</p>
<a href="https://Site.com/branded-app">About the Branded Site app</a>';
$string['moodlebrandedappreference'] = 'Alternatively, get a <a href="https://site.com/branded-app/">Branded Site app</a> with your own custom branding.';
$string['moodlepartners'] = 'Site Partners';
$string['moodlepartners_help'] = '<p>Site Partners are services providers that are certified by Site HQ to provide high quality Site services for your organisation\'s online learning environment.</p>
<a href="https://Site.com/about-partners/">About our Partners</a><br />
<a href="https://Site.com/partners">Find a Partner</a>';
$string['moodleservices'] = 'Site services';
$string['moodleservices_help'] = 'Make sure you get the best from your site learning environment by using these Site services:';
...
$string['opensslrecommended'] = 'Installing the optional OpenSSL library is highly recommended -- it enables Site Networking functionality.';
$string['opensslrequired'] = 'The OpenSSL PHP extension is now required by Site to provide stronger cryptographic services.';
...
$string['pathtosassc_help'] = 'Specifying the location of the SassC binary will switch the SASS compiler from Site\'s PHP implementation to SassC. See https://github.com/sass/sassc for more information.';
...
$string['pluginschecktodo'] = 'You must solve all the plugin requirements before proceeding to install this Site version!';
...
$string['profilingallowall_help'] = 'If you enable this setting, then, at any moment, you can use the PROFILEALL parameter anywhere (PGC) to enable profiling for all the executed scripts along the Site session life. Analogously, you can use the PROFILEALLSTOP parameter to stop it.';
...
$string['questioncwqpfscheck'] = 'One or more \'random\' questions in a quiz are set up to select questions from a mixture of shared and unshared question categories. There is a more detailed report <a href="{$a->reporturl}">here</a> and see Site Docs page <a href="{$a->docsurl}">here</a>.';
...
$string['quizattemptsupgradedmessage'] = 'In Site 2.1 there was a major upgrade to questions. It was possible to delay parts of the database upgrade to be run later. Before upgrading to Site 2.7, this upgrade must be completed.';
...
* You are contributing to our Site statistics of the worldwide community';
...
$string['releasenoteslink'] = 'For information about this version of Site, please see the online <a target="_blank" href="{$a}">Release Notes</a>';
...
$string['purgecachesconfirm'] = 'Site can cache themes, javascript, language strings, filtered text, rss feeds and many other pieces of calculated data.  Purging these caches will delete that data from the server and force browsers to refetch data, so that you can be sure you are seeing the most up-to-date values produced by the current code.  There is no danger in purging caches, but your site may appear slower for a while until the server and clients calculate new information and cache it.';
...
$string['sessionautostartwarning'] = '<p>Serious configuration error detected, please notify server administrator.</p><p> To operate properly, Site requires that administrator changes PHP settings.</p><p><code>session.auto_start</code> must be set to <code>off</code>.</p><p>This setting is controlled by editing <code>php.ini</code>, Apache/IIS <br />configuration or <code>.htaccess</code> file on the server.</p>';
...
$string['settingsafemode'] = 'Site is not fully compatible with safe mode, please ask server administrator to turn it off. Running Site under safe mode is not supported, please expect various problems if you do so.';
...
$string['showuseridentity_desc'] = 'When selecting or searching for users, and when displaying lists of users, these fields may be shown in addition to their full name. The fields are only shown to users who have the Site/site:viewuseridentity capability; by default, teachers and managers. (This option makes most sense if you choose one or two fields that are mandatory at your institution.)';
$string['simplexmlrequired'] = 'The SimpleXML PHP extension is now required by Site.';
...
$string['splrequired'] = 'The SPL PHP extension is now required by Site.';
...
$string['stickyblocksmymoodle'] = 'My Site';
...
$string['tokenizerrecommended'] = 'Installing the optional PHP Tokenizer extension is recommended -- it improves Site Networking functionality.';
...
$string['unsupporteddbfileformat'] = 'Your database uses Antelope as the file format. Full UTF-8 support in MySQL and MariaDB requires the Barracuda file format. Please switch to the Barracuda file format. See the documentation MySQL full unicode support</a> for details.';
...
$string['updateavailable'] = 'There is a newer Site version available!';
...
$string['updateavailable_release'] = 'Site {$a}';
...
$string['updateavailablenot'] = 'Your Site code is up-to-date!';
...
$string['updatenotificationfooter'] = 'Your Site site {$a->siteurl} is configured to automatically check for available updates. You are receiving this message as the administrator of the site. You can disable automatic checks for available updates in Site administration / Server / Update notifications or customise the delivery of this message via your preferences page.';
$string['updatenotificationsubject'] = 'Site updates are available ({$a->siteurl})';
$string['updateautocheck'] = 'Automatically check for available updates';
$string['updateautocheck_desc'] = 'If enabled, your site will automatically check for available updates for both Site code and all additional plugins. If there is a new update available, a notification will be sent to site admins.';
...
$string['updatenotifybuilds_desc'] = 'If enabled, the available update for Site code is also reported when a new build for the current version is available. Builds are continuous improvements of a given Site version. They are generally released every week. If disabled, the available update will be reported only when there is a higher version of Site released. Checks for plugins are not affected by this setting.';
$string['upgradestart'] = 'Upgrade Site database now';
...
$string['upgradepluginsinfo_help'] = 'There are available updates for some of your plugins. You should install them all prior to upgrading Site database. If your site does not support automatic updates deployment, you have to download and install new plugin versions at your server manually.';
...
$string['upgradeforumread'] = 'A new feature has been added in Site 1.5 to track read/unread forum posts.<br />To use this functionality you need to <a href="{$a}">update your tables</a>.';
$string['upgradeforumreadinfo'] = 'A new feature has been added in Site 1.5 to track read/unread forum posts.  To use this functionality you need to update your tables with all the tracking information for existing posts.  Depending on the size of your site this can take a long time (hours) and can be quite taxing on the database, so it\'s best to do it during a quiet period.  However, your site will continue functioning during this upgrade and users won\'t be affected.  Once you start this process you should let it finish (keep your browser window open).  However, if you stop the process by closing the window: don\'t worry, you can start over.<br /><br />Do you want to start the upgrading process now?';
...
$string['upgradesettingsintro'] = 'The settings shown below were added during your last Site upgrade. Make any changes necessary to the defaults and then click the \'Save changes\' button at the bottom of this page.';
$string['upgradestalefiles'] = 'Mixed Site versions detected, upgrade cannot continue';
$string['upgradestalefilesinfo'] = 'The Site update process has been paused because PHP scripts from at least two major versions of Site have been detected in the Site directory.

This can cause significant problems later, so in order to continue you must ensure that the Site directory contains only files for a single version of Site.

The recommended way to clean your Site directory is as follows:

* rename the current Site directory to "site_old"
* create a new Site directory containing only files from either a standard Site package download, or from the Site Git repository
* move the original config.php file and any non-standard plugins from the "site_old" directory to the new Site directory

When you have a clean Site directory, refresh this page to resume the Site update process.

This warning is often caused by unzipping a standard Site package over a previous version of Site. While this is OK for minor upgrades, it is strongly discouraged for major Site upgrades.
...
$string['upgradesure'] = '<p>Your Site files have been changed, and you are about to automatically upgrade your server to this version:</p>
<p><strong>{$a}</strong></p>
...
$string['webproxyinfo'] = 'Fill in following options if your Site server can not access internet directly. Internet access is required for download of environment data, language packs, RSS feeds, timezones, etc.<br /><em>PHP cURL extension is highly recommended.</em>';
$string['xmlrpcrecommended'] = 'The XMLRPC extension is useful for web services and Site networking.';
$string['yuicomboloading'] = 'YUI combo loading';
$string['ziprequired'] = 'The Zip PHP extension is now required by Site, info-ZIP binaries or PclZip library are not used anymore.';
...
$string['registermoodlenet'] = '<p>We\'d love to stay in touch and provide you with important things for your Site site!</p><p>By registering:</p><ul><li>You can subscribe to receive notifications of new Site releases, security alerts and other important news.</li><li>You can access and activate mobile push notifications from your Site site through our free .</li><li>You are contributing to our <a href="https://stats.Site.org">Site statistics</a> of the worldwide community, which help us improve Site and our community sites.</li><li>If you wish, your site can be included in the <a href="https://stats.Site.org/sites/">list of registered Site sites</a> in your country.</li></ul>';
...
$string['registermoodleorgli2'] = 'Statistics about your site will be added to the {$a} of the worldwide Site community.';
