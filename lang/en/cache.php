...
$string['privacy:metadata:cachestore'] = 'The Cache subsystem stores data temporarily on behalf of other parts of Site. This data is not easily identifiable, and is very short lived. It serves as a cache of data stored elsewhere in Site, and should therefore already be handled by those Site components.';
$string['purge'] = 'Purge';
