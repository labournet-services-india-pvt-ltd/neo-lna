...
$string['pinblocks'] = 'Configure pinned blocks for my site';
$string['pinblocksexplan'] = 'Any block settings you configure here will be visible (and non-editable) for any user of site on their \'My Site\' overview page.';
$string['defaultpage'] = 'Default My Site page';
