...
$string['cwrqpfsinfo'] = '<p>During the upgrade to site 1.9 we will separate question categories into
...
on upgrading to site 1.9. The following categories will have their sharing status changed. Questions which are
...
$string['exportasxml'] = 'Export as Site XML';
$string['exportcategory'] = 'Export category';
$string['exportcategory_help'] = 'This setting determines the category from which the exported questions will be taken.

Certain import formats, such as GIFT and Site XML, permit category and context data to be included in the export file, enabling them to (optionally) be recreated on import. If required, the appropriate checkboxes should be ticked.';
$string['exporterror'] = 'Errors occur during exporting!';
$string['exportfilename'] = 'questions';
$string['exportnameformat'] = '%Y%m%d-%H%M';
$string['exportonequestion'] = 'Download this question in Site XML format';
...
Certain import formats, such as GIFT and Site XML, may include category and context data in the import file. To make use of this data, rather than the selected category, the appropriate checkboxes should be ticked. If categories specified in the import file do not exist, they will be created.';
