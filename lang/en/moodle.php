...
$string['adminhelpmymoodle'] = 'Configure the My Site blocks for users';
...
$string['adminhelpstickyblocks'] = 'Configure Site-wide sticky blocks';
...
$string['backupnonisowarning'] = 'Warning: this backup is from a non-Unicode version of Site (pre 1.6). If this backup contains any non-ISO-8859-1 texts then they may be CORRUPTED if you try to restore them to this Unicode version of Site.';
...
The essential one is the session cookie, usually called SiteSession. You must allow this cookie in your browser to provide continuity and to remain logged in when browsing the site. When you log out or close the browser, this cookie is destroyed (in your browser and on the server).

The other cookie is purely for convenience, usually called SITEID or similar. It just remembers your username in the browser. This means that when you return to this site, the username field on the login page is already filled in for you. It is safe to refuse this cookie - you will just have to retype your username each time you log in.';
$string['cookiesenabledonlysession'] = 'Cookies must be enabled in your browser';
$string['cookiesenabledonlysession_help'] = 'This site uses one session cookie, usually called SiteSession. You must allow this cookie in your browser to provide continuity and to remain logged in when browsing the site. When you log out or close the browser, this cookie is destroyed (in your browser and on the server).';
...
$string['coursefileswarning_help'] = 'Course files are deprecated since Site 2.0, please use external repositories instead as much as possible.';
...
$string['courselegacyfiles_help'] = 'The course files area provides some backward compatibility with Site 1.9 and earlier.  All files in this area are always accessible to all participants in the course (whether you link to them or not) and there is no way to know where any of these files are being used in Site.
...
$string['databasechecking'] = 'Upgrading Site database from version {$a->oldversion} to {$a->newversion}';
...
$string['documentation'] = 'Site documentation';
...
$string['formattext'] = 'Site auto-format';
...
$string['gravatarenabled'] = '<a href="https://www.gravatar.com/">Gravatar</a> has been enabled for this site. If you don\'t upload a profile picture Site will attempt to load a profile picture for you from Gravatar.';
$string['group'] = 'Group';
...
$string['latestlanguagepack'] = 'Check for latest language pack on site.org';
...
$string['moodledocs'] = 'Site Docs';
$string['moodledocslink'] = 'Site Docs for this page';
$string['moodleversion'] = 'Site version';
$string['moodlerelease'] = 'Site release';
$string['more'] = 'more';
...
$string['mymoodledashboard'] = 'My Site dashboard';
...
$string['noticenewerbackup'] = 'This backup file has been created with Site {$a->backuprelease} ({$a->backupversion}) and it\'s newer than your currently installed Site {$a->serverrelease} ({$a->serverversion}). This could cause some inconsistencies because backwards compatibility of backup files cannot be guaranteed.';
...
$string['passwordextlink'] = 'The following link has been provided to recover your lost password. This will take you out of Site.';
...
$string['passwordnohelp'] = 'No help is available to find your lost password. Please contact your site administrator.';
...
$string['registration'] = 'Site registration';
...
$string['registrationcontactyes'] = 'Yes, provide a form for others to contact me';
$string['registrationemail'] = 'Email notifications';
$string['registrationinfo'] = '<p>This page allows you to register your Site site with site.org.  Registration is free.
The main benefit of registering is that you will be added to a low-volume mailing list
for important notifications such as security alerts and new releases of Site.</p>
<p>By default, your information will be kept private, and will never be sold or passed on to anyone else.  The only
   ...
   picture of the Site community as a whole.</p>
<p>If you choose, you can allow your site name, country and URL to be added to the public list of Sites.</p>
...
$string['registrationsend'] = 'Send registration information to site.org';
$string['registrationyes'] = 'Yes, notify me of new Site releases, security alerts and other important news';
