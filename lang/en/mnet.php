...
$string['expireyourkeyexplain'] = 'Site automatically rotates your keys every 28 days (by default) but you have the option to <em>manually</em> expire this key at any time. This will only be useful if you believe this key has been compromised. A replacement will be immediately automatically generated.<br />Deleting this key will make it impossible for other applications to communicate with you, until you manually contact each administrator and provide them with your new key.';
...
$string['moodle_home_help'] = 'The path to the homepage of MNet application on the remote host, e.g. /site/.';
$string['name'] = 'Name';
...
$string['notmoodleapplication'] = 'WARNING: This is not a Site application, so some of the inspection methods may not work properly.';
$string['notPEM'] = 'This key is not in PEM format. It will not work.';
$string['notpermittedtojump'] = 'You do not have permission to begin a remote session from this Site server.';
...
$string['trustedhostsexplain'] = '<p>The trusted hosts mechanism allows specific machines to execute calls via XML-RPC to any part of the Site API. This is available for scripts to control Site behaviour and can be a very dangerous option to enable. If in doubt, keep it off.</p>
