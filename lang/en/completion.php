...
$string['err_noroles'] = 'There are no roles with the capability site/course:markcomplete in this course.';
...
$string['manualcompletionbynote'] = 'Note: The capability site/course:markcomplete must be allowed for a role to appear in the list.';
