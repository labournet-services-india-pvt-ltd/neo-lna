...
$string['configallowexternallinks'] = 'This option enables all users to choose whether or not external media is copied into Site or not. If this is off then media is always copied into Site (this is usually best for overall data integrity and security).  If this is on then users can choose each time they add media to a text.';
...
$string['configgetfiletimeout'] = 'Timeout in seconds for downloading an external file into Site.';
...
$string['confirmdelete'] = 'Are you sure you want to delete the repository {$a}? If you choose "Continue and download", file references to external contents will be downloaded to Site. This could take a long time to process.';
...
$string['confirmremove'] = 'Are you sure you want to remove this repository plugin, its options and <strong>all of its instances</strong> - {$a}? If you choose "Continue and download", file references to external contents will be downloaded to Site. This could take a long time to process.';
