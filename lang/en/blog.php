...
$string['configexternalblogcrontime'] = 'How often Site checks the external blogs for new entries.';
$string['configmaxexternalblogsperuser'] = 'The number of external blogs each user is allowed to link to their Site blog.';
$string['configuseblogassociations'] = 'Enables the association of blog entries with courses and course modules.';
$string['configuseexternalblogs'] = 'Enables users to specify external blog feeds. Site regularly checks these blog feeds and copies new entries to the local blog of that user.';
