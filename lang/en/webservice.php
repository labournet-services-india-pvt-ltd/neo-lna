...
$string['createuserdescription'] = 'A web services user is required to represent the system controlling site.';
...
$string['key'] = 'Key';
$string['keyshelp'] = 'The keys are used to access your site account from external applications.';
...
$string['onesystemcontrolling'] = 'Allow an external system to control site';
$string['onesystemcontrollingdescription'] = 'The following steps help you to set up the site web services to allow an external system to interact with site. This includes setting up a token (security key) authentication method.';
...
$string['privacy:metadata:tokens'] = 'A record of tokens for interacting with site through web services or Mobile applications.';
...
$string['testauserwithtestclientdescription'] = 'Simulate external access to the service using the web service test client. Before doing so, log in as a user with the site/webservice:createtoken capability and obtain the security key (token) via the user\'s preferences page. You will use this token in the test client. In the test client, also choose an enabled protocol with the token authentication. <strong>WARNING: The functions that you test WILL BE EXECUTED for this user, so be careful what you choose to test!</strong>';
...
$string['userasclientsdescription'] = 'The following steps help you to set up the Site web service for users as clients. These steps also help to set up the recommended token (security keys) authentication method. In this use case, the user will generate their token from the security keys page via their preferences page.';
...
$string['wsclientdoc'] = 'Site web service client documentation';
