...
$string['admindirsetting'] = 'A very few webhosts use /admin as a special URL for you to access a
    ...
    standard location for the Site admin pages.  You can fix this by
    renaming the admin directory in your installation, and putting that
    new name here.  For example: <br /> <br /><b>Siteadmin</b><br /> <br />
    This will fix admin links in Site.';
...
$string['clialreadyconfigured'] = 'The configuration file config.php already exists. Please use admin/cli/install_database.php to install Site for this site.';
$string['clialreadyinstalled'] = 'The configuration file config.php already exists. Please use admin/cli/install_database.php to upgrade Site for this site.';
$string['cliinstallfinished'] = 'Installation completed successfully.';
$string['cliinstallheader'] = 'Site {$a} command line installation program';
...
$string['compatibilitysettingssub'] = 'Your server should pass all these tests to make Site run properly';
$string['configfilenotwritten'] = 'The installer script was not able to automatically create a config.php file containing your chosen settings, probably because the Site directory is not writeable. You can manually copy the following code into a file named config.php within the root directory of Site.';
...
$string['configurationcompletesub'] = 'Site made an attempt to save your configuration in a file in the root of your Site installation.';
...
$string['databasetypesub'] = 'Site supports several types of database servers. Please contact server administrator if you do not know which type to use.';
...
$string['dbtype'] = 'Type';
$string['directorysettings'] = '<p>Please confirm the locations of this Site installation.</p>

<p><b>Web address:</b>
Specify the full web address where Site will be accessed.
...
$string['directorysettingshead'] = 'Please confirm the locations of this Site installation';
...
$string['dirroot'] = 'Site directory';
$string['dirrooterror'] = 'The \'Site directory\' setting seems to be incorrect - we can\'t find a Site installation there. The value below has been reset.';
...
$string['environmentsub2'] = 'Each Site release has some minimum PHP version requirement and a number of mandatory PHP extensions.
...
$string['inputwebdirectory'] = 'Site directory:';
...
<p>This may cause Site to have memory problems later on, especially
...
<li>If you are able to, recompile PHP with <i>--enable-memory-limit</i>.
    This will allow Site to set the memory limit itself.</li>
...
<li>On some PHP servers you can create a .htaccess file in the Site directory
...
$string['nativemariadbhelp'] = '<p>The database is where most of the Site settings and data are stored and must be configured here.</p>
...
<p>If the database currently does not exist, and the user you specify has permission, Site will attempt to create a new database with the correct permissions and settings.</p>
<p>This driver is not compatible with legacy MyISAM engine.</p>';
$string['nativemysqli'] = 'Improved MySQL (native/mysqli)';
$string['nativemysqlihelp'] = '<p>The database is where most of the Site settings and data are stored and must be configured here.</p>
<p>The database name, username, and password are required fields; table prefix is optional.</p>
<p>The database name may contain only alphanumeric characters, dollar ($) and underscore (_).</p>
<p>If the database currently does not exist, and the user you specify has permission, Site will attempt to create a new database with the correct permissions and settings.</p>';
$string['nativeoci'] = 'Oracle (native/oci)';
$string['nativeocihelp'] = 'Now you need to configure the database where most Site data will be stored.
...
$string['nativepgsqlhelp'] = '<p>The database is where most of the Site settings and data are stored and must be configured here.</p>
...
$string['nativesqlsrvhelp'] = 'Now you need to configure the database where most Site data will be stored.
This database must already have been created and a username and password created to access it. Table prefix is mandatory.';
...
control panel or something.  Unfortunately this conflicts with the standard location for the Site admin pages.  You can fix this by
renaming the admin directory in your installation, and putting that  new name here.  For example: <em>moodleadmin</em>. This will fix admin links in Site.';
$string['pathssubdataroot'] = '<p>A directory where Site will store all file content uploaded by users.</p>
...
$string['pathssubwwwroot'] = '<p>The full address where Site will be accessed i.e. the address that users will enter into the address bar of their browser to access Site.</p>
<p>It is not possible to access Site using multiple addresses. If your site is accessible via multiple addresses then choose the easiest one and set up a permanent redirect for each of the other addresses.</p>
...
$string['phpversionhelp'] = '<p>Site requires a PHP version of at least 5.6.5 or 7.1 (7.0.x has some engine limitations).</p>
<p>You are currently running version {$a}.</p>
<p>You must upgrade PHP or move to a host with a newer version of PHP.</p>';
$string['releasenoteslink'] = 'For information about this version of Site, please see the release notes at {$a}';
$string['safemode'] = 'Safe mode';
$string['safemodeerror'] = 'Site may have trouble with safe mode on';
$string['safemodehelp'] = '<p>Site may have a variety of problems with safe mode on, not least is that
...
<p>Safe mode is usually only enabled by paranoid public web hosts, so you may have
   to just find a new web hosting company for your Site site.</p>
...
$string['sessionautostarthelp'] = '<p>Site requires session support and will not function without it.</p>
...
$string['welcomep30'] = 'This release of the <strong>{$a->installername}</strong> includes the applications
    to create an environment in which <strong>Site</strong> will operate, namely:';
$string['welcomep40'] = 'The package also includes <strong>Site {$a->moodlerelease} ({$a->moodleversion})</strong>.';
...
$string['welcomep60'] = 'The following pages will lead you through some easy to follow steps to
    configure and set up <strong>Site</strong> on your computer. You may accept the default
    settings or, optionally, amend them to suit your own needs.';
$string['welcomep70'] = 'Click the "Next" button below to continue with the set up of <strong>Site</strong>.';
