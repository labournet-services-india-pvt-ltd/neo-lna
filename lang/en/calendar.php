...
$string['pref_persistflt_help'] = 'If this is enabled, then Site will remember your last event filter settings and automatically restore them each time you login.';
