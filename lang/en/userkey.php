...
$string['userkey_help'] = 'Select a saved key that will give users access to the data published by this export plugin, without having to log into Site. Select "Create a new user key" to generate a new key when submitting this form.';
