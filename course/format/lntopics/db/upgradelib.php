 ...
 * these sections.
 */
function format_lntopics_upgrade_remove_numsections() {
    global $DB;
    ...
    $params = ['format1' => 'lntopics', 'format2' => 'lntopics', 'numsections' => 'numsections'];
    ...
    foreach ($needfixing as $courseid => $numsections) {
        format_lntopics_upgrade_hide_extra_sections($courseid, $numsections);
    }

    foreach ($needsections as $courseid => $numsections) {
        format_lntopics_upgrade_add_empty_sections($courseid, $numsections);
    }

    $DB->delete_records('course_format_options', ['format' => 'lntopics', 'sectionid' => 0, 'name' => 'numsections']);
}
 ...
 */
function format_lntopics_upgrade_hide_extra_sections($courseid, $numsections) {
    global $DB;
 ...
 * @param int $numsections
 */
function format_lntopics_upgrade_add_empty_sections($courseid, $numsections) {
    global $DB;
