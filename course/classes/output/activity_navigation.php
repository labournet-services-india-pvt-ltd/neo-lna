...
class activity_navigation implements renderable, templatable {
    ...
    public function __construct($prevmod, $nextmod, $activitylist = array()) {
        ...
        if ($prevmod) {
            ...
            $attributes = [
                'class' => 'btn btn-link btn-primary btn-prev',
        ...
        if ($nextmod) {
            ...
            $attributes = [
                'class' => 'btn btn-link btn-primary btn-next',
        ...
        //for essci dont not show previous,next and acctivitylist pre assessement test course  added by prashant on jan-2020;
        global $COURSE, $CFG;
    ...
    public function export_for_template(\renderer_base $output) {
        ...
        if ($this->activitylist) {
          //Mihir LN no need to show jumpto dropdown
